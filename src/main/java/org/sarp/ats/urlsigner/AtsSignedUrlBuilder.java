...
public class AtsSignedUrlBuilder implements SignedUrlBuilder {
    ...
    public String compact() {
        ...
        sb.append("E=").append(this.getExpireTimeSeconds(timeToLive, timeUnit)).append("&");
    ...
    private long getExpireTimeSeconds(int timeToLive, TimeUnit timeUnit) {
